...
public class GhostBlobBehavior : BlobMergeBehavior
{
    ...
    public override void FinalizeMergeFromTarget(MergeContext context)
    {
        var plan = context.Plan;
        ...
        MergePlan hauntedPlan = model.CalculateMergePlan(_blob, plan.SourceBlob);
        ...
        plan.DeferredPlans.Add(hauntedPlan);
