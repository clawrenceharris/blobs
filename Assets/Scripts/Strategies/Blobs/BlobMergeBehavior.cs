...
public interface IMergeBehavior
{
    ...
    void FinalizeMergeFromTarget(MergeContext context);
    void FinalizeMergeFromSource(MergeContext context);
...
public class BlobMergeBehavior : IMergeBehavior
{
    ...
    public virtual void FinalizeMergeFromTarget(MergeContext context)
    {
        return;
    }
     public virtual void FinalizeMergeFromSource(MergeContext context)
    {
        return;
    }
    ...
    public virtual void ModifyMergeFromSource(MergeContext context)
    {
        ...
        else if (source.Size == BlobSize.Normal && current.Size == BlobSize.Normal)
        {
            RemoveCurrentBlob(context);
        }
        else if (source.Size == BlobSize.Small && current.Size == BlobSize.Small)
        {
    ...
    protected void RemoveCurrentBlob(MergeContext context)
    {
        ...
        context.Plan.BlobsToRemoveOnPath.TryAdd(context.CurrentBlob, context.CurrentPos);
    }
